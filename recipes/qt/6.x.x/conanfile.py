...
class QtConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["qtCore"].set_property('pkg_config_custom_content', 'bindir=${prefix}/bin')
        self.cpp_info.components["qtCore"].set_property('pkg_config_custom_content', 'libexecdir=${prefix}/bin')
        self.cpp_info.components["qtCore"].set_property('pkg_config_custom_content', 'exec_prefix=${prefix}')
